...
# Configurar modelo Usuario personalizado
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 1000,  # Aumentado para soportar grandes listas de asignaturas
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'API Colegio Django',
    'DESCRIPTION': 'API REST para gestión de colegio',
    'VERSION': '1.0.0',
